...
class DataSet:
    ...
    angle: list[tuple]
        list of tuple with rotation angles. 0: angle of x-axis, 1: angle of y-axis
    ...
    Methods
    ----------
    add_data(time_s: float, x_mm: float, y_mm: float, roll_deg: float, pitch_deg: float,
                 angle:tuple = (), shift:tuple = (), adj_x: float = 0, adj_y: float = 0)
    ...
    def add_data(self, time_s: float, x_mm: float, y_mm: float, roll_deg: float, pitch_deg: float,
                 angle:tuple = (), shift:tuple = (), adj_x: float = 0, adj_y: float = 0) -> None:
        """
        Adds data to the dataset
...
def extract_angles(dataset: DataSet) -> list:
    """
    Extract angles of rotation between x-axis of global reference frame and x-axis of local reference frame
    """
